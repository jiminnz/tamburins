        ...
        <div id={style.footer_wrap}>
            { isSub === true && (
                <div className={style.sub_footer}>
                    ...
                    <dl>
                        ...
                        <dd><Link to="/*">공지사항</Link></dd>
                        <dd><Link to="/*">주문 배송 조회</Link></dd>
                        <dd><Link to="/*">적립금 현황</Link></dd>
                        <dd><Link to="/*">고객서비스</Link></dd>
                        <dd><Link to="/*">자주 묻는 질문</Link></dd>
                        <dd><Link to="/*">1:1문의하기</Link></dd>
                    </dl>
                    <dl>
                        <dt>소셜</dt>
                        ...
                        <dd><Link to="/*">Weibo</Link></dd>
                        <dd><Link to="/*">Facebook</Link></dd>
                    </dl>
                </div>
            )}
            <footer id={style.footer}>
                ...
                <ul className={style.info}>
                    ...
                    <li>통신판매업신고: 제 2014-서울마포-1050 호 <Link to="/*">(사업자정보확인)</Link></li>
                    <li><Link to="/*">개인정보처리방침</Link></li>  
                    <li><Link to="/*">이용약관</Link></li>
                </ul>
                {/* <p>고객님의 안전한 현금자산 거래를 위하여 하나은행과 채무지급보증계약을 체결하여 보장해드리고 있습니다. <a href="#none" title="서비스 가입사실 확인">서비스 가입사실 확인</a></p> */}
                <p>고객님의 안전한 현금자산 거래를 위하여 하나은행과 채무지급보증계약을 체결하여 보장해드리고 있습니다. <Link to="/*">서비스 가입사실 확인</Link></p>
                <ul>
                    <li>&#169; 탬버린즈</li>
                    <li>대한민국</li>
                </ul>
